...
{
	Dio_vidSetPinValue(Dio_PORTA,RS,STD_LOW);
	Dio_vidSetPinValue(Dio_PORTA,RW,STD_LOW);
	Dio_vidSetPinValue(Dio_PORTA,E,STD_HIGH);
	Dio_vidSetPortValue(Dio_PORTD,u8CmdCpy);
	Dio_vidSetPinValue(Dio_PORTA,E,STD_LOW);
	_delay_ms(5);
	Dio_vidSetPinValue(Dio_PORTA,E,STD_HIGH);
...
{
	Dio_vidSetPinValue(Dio_PORTA,RS,STD_HIGH);
	Dio_vidSetPinValue(Dio_PORTA,RW,STD_LOW);
	Dio_vidSetPinValue(Dio_PORTA,E,STD_HIGH);
